...
export default function StrangerThings() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <button onClick={() => router.back()} className="mt-6 px-6 py-2 bg-red-600 text-white font-semibold rounded-lg">&larr; Back</button>
<br /> <br /> <br />
      ...
      <h5 className="text-2xl font-bold mt-6">Streaming Platform:</h5>
